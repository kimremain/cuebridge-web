...
#login .g_login .btn_login{position:absolute;top:140px;right:135px}
...
<div class="mw_login open">
    ...
    <div id="login" class="g_login">
        ...
        <form  action="/auth/loginProcess" method="post"  id="g_login" class="g_login" method="post">        
        <input type="hidden" name="${_csrf.parameterName}" 	value="${_csrf.token}" />
            <fieldset>
                <!-- <legend>Lincus Login</legend> -->
                <div class="item">
                    <label for="oid" class="i_label">ID</label><input name="idUser" type="text" value="" id="oid" class="i_text oid">
                </div>
                <div class="item">
                    <label for="opw" class="i_label">PASSWORD</label><input name="dsPwd" type="password" id="opw" class="i_text opw">                    
                </div>
                <p class="keeping"></p>
                <p class="warning"></p>
                <br><br>
