...
public class BexToAdvanceVO extends BaseVO{

    /**
     * 
     */
    private static final long serialVersionUID = -1980816066673707518L;
    ...
    private String agent_route;
    private String agent_route_memo;
    private String member_contact;
    private String member_contact_memo;
    private String member_route;
    private String member_route_memo;
    private String collection_date;
    private String collection_main;
    private String collection_sub;
    ...
    private String agent1_reg_code;
    ...
    private String agent2_reg_code;
    ...
    private String agent3_reg_code;
    ...
    private String agent4_reg_code;
    ...
    private String agent5_reg_code;
    ...
    private String agent6_reg_code;
    ...
    private String agent7_reg_code;
    ...
    private String agent8_reg_code;
    ...
    private String agent9_reg_code;
    ...
    public String getAgent_route() {
        return agent_route;
    }
    public void setAgent_route(String agent_route) {
        this.agent_route = agent_route;
    }
    public String getAgent_route_memo() {
        return agent_route_memo;
    }
    public void setAgent_route_memo(String agent_route_memo) {
        this.agent_route_memo = agent_route_memo;
    }
    ...
    public String getMember_contact_memo() {
        return member_contact_memo;
    }
    public void setMember_contact_memo(String member_contact_memo) {
        this.member_contact_memo = member_contact_memo;
    }
    ...
    public String getMember_route_memo() {
        return member_route_memo;
    }
    public void setMember_route_memo(String member_route_memo) {
        this.member_route_memo = member_route_memo;
    }
    ...
    public String getCollection_main() {
        return collection_main;
    }
    public void setCollection_main(String collection_main) {
        this.collection_main = collection_main;
    }
    public String getCollection_sub() {
        return collection_sub;
    }
    public void setCollection_sub(String collection_sub) {
        this.collection_sub = collection_sub;
    }
    ...
    public String getAgent_reg_code() {
        return agent_reg_code;
    }
    public void setAgent_reg_code(String agent_reg_code) {
        this.agent_reg_code = agent_reg_code;
    }
    ...
    public String getAgent1_reg_code() {
        return agent1_reg_code;
    }
    public void setAgent1_reg_code(String agent1_reg_code) {
        this.agent1_reg_code = agent1_reg_code;
    }
    ...
    public String getAgent2_reg_code() {
        return agent2_reg_code;
    }
    public void setAgent2_reg_code(String agent2_reg_code) {
        this.agent2_reg_code = agent2_reg_code;
    }
    ...
    public String getAgent3_reg_code() {
        return agent3_reg_code;
    }
    public void setAgent3_reg_code(String agent3_reg_code) {
        this.agent3_reg_code = agent3_reg_code;
    }
    ...
    public String getAgent4_reg_code() {
        return agent4_reg_code;
    }
    public void setAgent4_reg_code(String agent4_reg_code) {
        this.agent4_reg_code = agent4_reg_code;
    }
    ...
    public String getAgent5_reg_code() {
        return agent5_reg_code;
    }
    public void setAgent5_reg_code(String agent5_reg_code) {
        this.agent5_reg_code = agent5_reg_code;
    }
    ...
    public String getAgent6_reg_code() {
        return agent6_reg_code;
    }
    public void setAgent6_reg_code(String agent6_reg_code) {
        this.agent6_reg_code = agent6_reg_code;
    }
    ...
    public String getAgent7_reg_code() {
        return agent7_reg_code;
    }
    public void setAgent7_reg_code(String agent7_reg_code) {
        this.agent7_reg_code = agent7_reg_code;
    }
    ...
    public String getAgent8_reg_code() {
        return agent8_reg_code;
    }
    public void setAgent8_reg_code(String agent8_reg_code) {
        this.agent8_reg_code = agent8_reg_code;
    }
    ...
    public String getAgent9_reg_code() {
        return agent9_reg_code;
    }
    public void setAgent9_reg_code(String agent9_reg_code) {
        this.agent9_reg_code = agent9_reg_code;
    }
