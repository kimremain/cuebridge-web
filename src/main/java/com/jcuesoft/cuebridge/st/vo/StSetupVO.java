...
public class StSetupVO extends BaseVO{

    /**
     * 
     */
    private static final long serialVersionUID = 3038334649069779979L;
    ...
    private String dsNasImgPath;
    
    private String dsNasWavPath;
    ...
    public void setDsNasImgPath(String dsNasImgPath) {
        this.dsNasImgPath = dsNasImgPath;
    }

    public String getDsNasWavPath() {
        return dsNasWavPath;
    }

    public void setDsNasWavPath(String dsNasWavPath) {
        this.dsNasWavPath = dsNasWavPath;
    }    
